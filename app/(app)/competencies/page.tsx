        ...
        {competencies.map((c) => (
          <li key={c.id}>
            <Link
              ...
              className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 rounded-lg border-l-2 border-line bg-canvas-subtle px-5 py-4 hover:border-fg-subtle"
